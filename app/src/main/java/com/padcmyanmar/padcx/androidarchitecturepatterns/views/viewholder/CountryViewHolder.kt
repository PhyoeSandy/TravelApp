package com.padcmyanmar.padcx.androidarchitecturepatterns.views.viewholder
...
class CountryViewHolder(itemView: View,private val delegate: ToursItemDelegate) : BaseTravelViewHolder(itemView) {
    ...
    init{
        ...
        itemView.ivCountry.setOnClickListener {
            mData?.let {
                delegate.onTapToursItem(it.name)
            }
        }
